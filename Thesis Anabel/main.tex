...
\part{Appendix and Bibliography} % New part of the thesis for the appendix

\let\cleardoublepage\clearpage \include{Chapters/Chapter0A} % Appendix A
%\include{Chapters/Chapter0B} % Appendix B - empty template

%-----------------------------------------------------------------------------

\let\cleardoublepage\clearpage \include{FrontBackMatter/Bibliography} 
\end{document}
